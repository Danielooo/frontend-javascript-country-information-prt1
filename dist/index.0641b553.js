...
async function fetchCountryData() {
    try {
        const response = await (0, _axiosDefault.default).get("https://restcountries.com/v3.1/all?fields=flags,name,population,region");
        let countries = response.data;
        countries = countries.sort((a, b)=>a.population - b.population);
        createListItems(countries);
    } catch (e) {
        console.error(e);
        if (e.response.status === 404) errorMessage.textContent = "Pagina niet gevonden | 404";
        else if (e.response.status === 500) errorMessage.textContent = "Internal server error | 500";
        else errorMessage.textContent = e;
    }
}
...
var Buffer = require("e30da4f5b323d964").Buffer;
"use strict";
/**
...
},{"e30da4f5b323d964":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("eaaf4718857a960");
var ieee754 = require("5f9987feb759e467");
...
},{"eaaf4718857a960":"eIiSV","5f9987feb759e467":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
